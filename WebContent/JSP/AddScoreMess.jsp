	...
	<body class="">
		...
		<div class="content">
			...
			<div class="header">
				...
				<h1 class="page-title">Add Score Message</h1>
			</div>

			<ul class="breadcrumb">
				<li>
					<a href="index.jsp">Home</a> <span class="divider">/</span></li>
				<li>Add Score Message</li>
			</ul>
				...
				<div class="row-fluid">
					...
					<div class="well">
						<form action="/StuSys/SaveExcelServlet" id="tab" method="post" enctype="multipart/form-data">
							<input type="hidden" name="path" value="/AddScoreMess.jsp" />
							<label>批量上传学生成绩信息(请上传Excel表,学生ID+课程ID+成绩+年级)</label> <input name="file" type="file" value="" class="input-xlarge">
