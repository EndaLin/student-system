	...
	<body class="">
		...
		<div class="content">
			...
			<div class="header">
				...
				<h1 class="page-title">注册账号审核</h1>
			</div>

			<ul class="breadcrumb">
				<li>
					<a href="index.jsp">Home</a> <span class="divider">/</span></li>
				<li class="active">注册账号审核</li>
			</ul>
				...
				<div class="row-fluid">
					...
					<div class="well">
						<table class="table">
							...
							<tbody>
								<c:forEach var="p" items="${userlist}" varStatus="status">
									<tr>
										<td>${status.count }</td>
										<td>${p.account}</td>
										<td>
											<a href="/StuSys/AcceptAccountServlet?id=${p.account }">yes</a>
										</td>
									</tr>
								</c:forEach>
							</tbody>
