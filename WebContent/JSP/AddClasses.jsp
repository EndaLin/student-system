	...
	<body>
		...
		<div class="content">
			...
			<ul class="breadcrumb">
				...
				<li>
					<a href="Classes.jsp">Classes</a> <span class="divider">/</span></li>
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active in" id="home">
								<form action="/StuSys/AddClasses" id="tab" method="post">
									<label>Class name</label> <input type="text" name="name" class="input-xlarge">
									<label>Grade</label> <input type="text" name="grade" class="input-xlarge">
