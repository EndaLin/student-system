					...
					<div class="well">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active in" id="home">
								<form action="/StuSys/AddStudent" id="tab" method="post">
									<label>Student Name</label> <input name="name" type="text" value="" class="input-xlarge">
									<label>Type</label>
									<select name="type" id="DropDownTimezone" class="input-xlarge">
										<c:forEach var="p" items="${clist}">
											<option value="${p.cid}">${p.grade} ${p.cname}</option>
										</c:forEach>
									</select>
								...
								<form action="/StuSys/SaveExcelServlet" id="tab" method="post" enctype="multipart/form-data">
									<input type="hidden" name="path" value="/AddStudent.jsp" />
									<label>批量上传学生信息(请上传Excel表，学生姓名+班级ID)</label> <input name="file" type="file" value="" class="input-xlarge">
									<div class="btn-toolbar">
										<button action="submit" class="btn btn-primary">
