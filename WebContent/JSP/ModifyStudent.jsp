					...
					<div class="well">
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active in" id="home">
								<form action="/StuSys/ModifyStudentServlet?id=<%=request.getParameter(" id ") %>" id="tab" method="post">
									Student ID :
									<%=request.getParameter("id") %> <br />
									<label>Student Name</label> <input name="name" type="text" value=<%=request.getParameter( "name") %> class="input-xlarge">
									<label>Class</label>
									<select name="cid" id="DropDownTimezone" class="input-xlarge">
										<option value="<%=request.getParameter(" cid ") %>">
											<%=request.getParameter("cgrade") %>
