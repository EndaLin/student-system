				...
				<div class="row-fluid">
					...
					<div class="well">
						<form action="/StuSys/SaveExcelServlet" id="tab" method="post" enctype="multipart/form-data">
							<input type="hidden" name="path" value="/assignmentCourse.jsp" />
							<label>批量上传学生排课表的信息(请上传Excel表，学生ID+课程ID+年级)</label> <input name="file" type="file" value="" class="input-xlarge">
