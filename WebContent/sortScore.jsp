...
<body class="">
	...
	<div class="content">
		...
		<div class="header">
			...
			<h1 class="page-title">班级成绩排名管理</h1>
		</div>

		<ul class="breadcrumb">
			<li><a href="index.jsp">Home</a> <span class="divider">/</span></li>
			<li class="active">班级成绩排名管理</li>
		</ul>
		<form action="/StuSys/SortStudentInClassServlet" method="post"
			style="margin-left: 20px;">
			请选择学期号（按学期号查询）: <select name="item">
			...
			<div class="row-fluid">
				...
				<div class="well">
					<table class="table">
						...
						<tbody>
							<c:forEach var="p" items="${ScoreMess1}" varStatus="status">
								<tr>
									<td>${status.count}</td>
									<td>${p.sid}</td>
									<td>${p.sname}</td>
