	...
	<body class="">
		...
		<div class="content">
			...
			<div class="header">
				...
				<h1 class="page-title">查询学生个人信息</h1>
			</div>

			<ul class="breadcrumb">
				<li>
					<a href="index.jsp">Home</a> <span class="divider">/</span></li>
				<li class="active">查询学生个人信息</li>
			</ul>
			<form action="/StuSys/FindStudentById" method="post" style="margin-left:20px;">
				请输入学生的ID:
						...
						<table class="table">
							...
							<tbody>
								<tr>
									...
									<td>${stu.sname}</td>
									<td>${stu.cid }</td>
									<td>${stu.cgrade} ${stu.cname}</td>
									<td>
										<a href="/StuSys/ModifyStudent.jsp?id=${stu.sid }&name=${stu.sname}&cid=${stu.cid}&cname=${stu.cname}&cgrade=${stu.cgrade}"><i class="icon-pencil"></i></a>
								...
								<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									...
									<div class="modal-footer">
										...
										<button class="btn" data-dismiss="modal" onClick="window.open('/StuSys/DeleteStudentByIdServlet?id=${stu.sid}')">Delete</button>
									</div>
								</div>
							</tbody>
						</table>
