					...
					<table class="table">
						...
						<tbody>
								<tr>
									...
									<td><a
										href="/StuSys/ModifyStudent.jsp?id=${stu.sid }&name=${stu.sname}&cid=${stu.cid}&cname=${stu.cname}&cgrade=${stu.cgrade}"><i
								...
								<div class="modal small hide fade" id="myModal" tabindex="-1"
									...
									<div class="modal-footer">
										...
										<button class="btn" data-dismiss="modal"
											onClick="window.open('/StuSys/DeleteStudentByIdServlet?id=${stu.sid}')">Delete</button>
									</div>
								</div>
						</tbody>
					</table>
