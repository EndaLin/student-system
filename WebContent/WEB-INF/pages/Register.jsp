				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						...
						<div class="form-bottom">
							<form role="form" action="/StuSys/RegisterServlet" method="post"
								class="login-form">
								<div class="form-group">
									<label class="sr-only" for="form-username">请输入您的账号:</label> <input
										type="text" name="form-username" placeholder="请输入您的账号..."
