...
/**
 * Servlet Filter implementation class ShowAllSubjects
 */
@WebFilter(dispatcherTypes = {
				...
				DispatcherType.ERROR
					...
					, urlPatterns = { "/showCourse.jsp" })
public class ShowAllCourseFilter implements Filter {

    /**
     * Default constructor. 
     */
    public ShowAllCourseFilter() {
